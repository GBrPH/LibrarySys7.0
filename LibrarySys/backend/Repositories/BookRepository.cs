...
namespace LibrarySys.BackEnd.Repositories
{
    public class BookRepository
    {
        ...
        private void SeedData()
        {
            ...
            {
                new Book { Title = "The Clean Coder", Author = "Robert C. Martin", BorrowerName = "", Copies = 5, IsAvailable = true },
                new Book { Title = "Design Patterns", Author = "Erich Gamma", BorrowerName = "", Copies = 3, IsAvailable = true },
                new Book { Title = "React Key Concepts", Author = "Maximilian S.", BorrowerName = "John Doe", Copies = 0, IsAvailable = false, BorrowedByUserId = 2 },
                new Book { Title = "Pro ASP.NET Core 7", Author = "Adam Freeman", BorrowerName = "", Copies = 2, IsAvailable = true }
            };
            ...
            {
                if (!_bookdb.Books.Any(b => b.Title == book.Title))
                {
